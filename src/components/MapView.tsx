...
import { Navigation2, MapPin, Star, Clock, ExternalLink, X, Locate, ZoomIn, ZoomOut } from 'lucide-react';
import { Link } from 'react-router-dom';
import { Button } from '@/components/ui/button';
import { Badge } from '@/components/ui/badge';
import { Salon } from '@/types';
import { formatCurrency } from '@/lib/format';
import { estimateTravelDuration } from '@/lib/format';
...
const MapView = ({ salons, userLocation, onSalonSelect, onNavigate }: MapViewProps) => {
                  ...
                  {salon.distance !== undefined && salon.distance !== null && (
                    <div className="flex items-center gap-3 text-xs">
                      ...
                      <div className="flex items-center gap-1 text-muted-foreground">
                        ...
                        {estimateTravelDuration(salon.distance)}
                      </div>
                    </div>
                  )}
                  ...
                  <div className="flex items-center gap-2 mt-1 text-xs text-muted-foreground">
                    ...
                    {selectedSalon.distance !== undefined && selectedSalon.distance !== null && (
                      <>
                        ...
                        <span>•</span>
                        <span>{estimateTravelDuration(selectedSalon.distance)}</span>
                      </>
                    )}
                  </div>
